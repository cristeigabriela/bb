...
`bb-types-tui` is a TUI version of the `bb-types` CLI application crate, using its library code, and exposing the data that is gathered with it to a [`bb-tui`](../../crates/bb-tui/) data model.
