...
`bb-consts-tui` is a TUI version of the `bb-consts` CLI application crate, using its library code, and exposing the data that is gathered with it to a [`bb-tui`](./util/bb-tui/) data model.
